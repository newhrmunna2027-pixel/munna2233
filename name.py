...
# This section defines the necessary classes from your _pb2.py files.
# The problematic boilerplate code has been removed.
...
def home():
    return jsonify({
        "AppName": "Info Flask Api", "Version": "4.1.0-Vercel-Fix", "Author": "Zero Gravity",
...
def get_account_info():
    ...
    try:
        ...
        return_data = loop.run_until_complete(GetAccountInformation(uid, "7", "/GetPlayerPersonalShow"))
        loop.close()
